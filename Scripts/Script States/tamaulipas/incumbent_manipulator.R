...
output_dir <- file.path(getwd(), "Processed Data/tamaulipas/Incumbents")
...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_tamaulipas_inafed.xlsx")
...
vote_db <- read_csv("Processed Data/tamaulipas/tamaulipas_vote_manipulation.csv")
...
output_path <- file.path(output_dir, "tamaulipas_incumbent_manipulator.csv")
