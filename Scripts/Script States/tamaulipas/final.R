...
db <- read_excel("tamaulipas/tamaulipas_collapsed_edited.xlsx")
og <- read.csv("tamaulipas/tamaulipas_FINAL_draft.csv")
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/tamaulipas/tamaulipas_FINALV.csv")
