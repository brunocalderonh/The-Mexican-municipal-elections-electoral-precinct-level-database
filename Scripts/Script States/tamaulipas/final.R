...
db <- read_excel("Data/collapsed database manual cases/tamaulipas_collapsed_edited.xlsx")
og <- read.csv("Processed Data/tamaulipas/tamaulipas_vote_calculator.csv")
...
output_path <- file.path(output_dir, "tamaulipas_final.csv")
