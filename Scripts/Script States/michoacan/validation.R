...
db <- read_csv("Processed Data/michoacan/michoacan_final.csv")
...
#   filter(year == 2012) %>%
#   select(
#     uniqueid, year, section, incumbent_party_magar, incumbent_party_JL, incumbent_party_Horacio, incumbent_party_inafed, 
#     contains("PRI"),
#     contains("PVEM")
#   ) 
