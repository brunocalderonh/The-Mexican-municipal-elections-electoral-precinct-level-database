...
db <- read_excel("Data/collapsed database manual cases/michoacan_collapsed_edited.xlsx")
og <- read.csv("Processed Data/michoacan/michoacan_FINAL_draft.csv")
...
output_path <- file.path(output_dir, "michoacan_FINALV.csv")
