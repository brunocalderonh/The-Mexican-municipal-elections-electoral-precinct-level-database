...
output_dir <- file.path(getwd(), "Processed Data/michoacan/Incumbents")
...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_michoacan_inafed.xlsx")
...
vote_db <- read_csv("Processed Data/michoacan/michoacan_vote.csv")
...
output_path <- file.path(output_dir, "michoacan_merged_IncumbentVote.csv")
