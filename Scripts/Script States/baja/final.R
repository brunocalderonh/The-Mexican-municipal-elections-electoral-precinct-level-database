...
db <- read_excel("Data/collapsed database manual cases/baja_collapsed_edited.xlsx")
og <- read.csv("Processed Data/baja/baja_vote_calculator.csv")
...
output_path <- file.path(output_dir, "baja_final.csv")
