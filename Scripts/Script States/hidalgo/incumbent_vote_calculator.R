...
# Load the data
finaldb <- read_dta( "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/hidalgo/hidalgo_merged_IncumbentVote.dta")
...
# Ensure that "PC" is replaced with "MC" only when the year is 2016
finaldb <- finaldb %>%
...
write.csv(finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/hidalgo/hidalgo_FINAL_draft.csv")


#CLEAN DB
  # Select only the desired columns
  hidalgo_finaldb <- finaldb %>% 
  select(
    state,
    mun,
    section,
  ...
  write.csv(hidalgo_finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/hidalgo/hidalgo_FINAL.csv")
