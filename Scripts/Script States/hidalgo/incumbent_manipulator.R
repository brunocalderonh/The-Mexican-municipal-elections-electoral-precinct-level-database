...
output_dir <- file.path(getwd(), "Processed Data/hidalgo/Incumbents")
...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_hidalgo_inafed.xlsx")
...
vote_db <- read_csv("Processed Data/hidalgo/hidalgo_vote_manipulation.csv")
...
output_path <- file.path(output_dir, "hidalgo_incumbent_manipulator.csv")
