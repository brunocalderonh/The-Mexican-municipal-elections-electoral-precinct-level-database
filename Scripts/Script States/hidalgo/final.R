...
db <- read_excel("Data/collapsed database manual cases/hidalgo_collapsed_edited.xlsx")
og <- read.csv("Processed Data/hidalgo/hidalgo_vote_calculator.csv")
...
output_path <- file.path(output_dir, "hidalgo_final.csv")
