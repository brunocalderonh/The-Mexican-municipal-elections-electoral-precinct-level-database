...
db <- read_excel("Data/collapsed database manual cases/chihuahua_collapsed_edited.xlsx")
og <- read.csv("Processed Data/chihuahua/chihuahua_vote_calculator.csv")
...
output_path <- file.path(output_dir, "chihuahua_final.csv")
