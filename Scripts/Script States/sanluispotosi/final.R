...
db <- read_excel("sanluispotosi/sanluispotosi_collapsed_edited.xlsx")
og <- read.csv("sanluispotosi/sanluispotosi_FINAL_draft.csv")
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/sanluispotosi/sanluispotosi_FINALV.csv")
