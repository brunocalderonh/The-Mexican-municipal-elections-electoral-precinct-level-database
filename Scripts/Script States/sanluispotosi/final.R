...
db <- read_excel("Data/collapsed database manual cases/sanluispotosi_collapsed_edited.xlsx")
og <- read.csv("Processed Data/sanluispotosi/sanluispotosi_vote_calculator.csv")
...
output_path <- file.path(output_dir, "sanluispotosi_final.csv")
