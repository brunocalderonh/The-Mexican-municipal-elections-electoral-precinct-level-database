...
db <- read_excel("campeche/campeche_collapsed_edited.xlsx")
og <- read.csv("campeche/campeche_FINAL_draft.csv")
...
# List of columns that should not be numeric
non_numeric_columns <- c(
  "uniqueid", "year", "state", "mun", "section",
  "incumbent_party_magar", "incumbent_candidate_magar", "incumbent_vote",
  "party_component", "mutually_exclusive", "researched_incumbent",
  "source_researched_incumbent", "incumbent_party_JL", "incumbent_candidate_JL",
  "incumbent_party_Horacio", "incumbent_party_inafed", "incumbent_candidate_inafed",
  "state_year", "state_incumbent_party", "state_incumbent_candidate"
)

# Convert all other columns to numeric to ensure correct types
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/campeche/campeche_FINALV.csv")
