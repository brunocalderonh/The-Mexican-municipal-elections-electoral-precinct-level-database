...
output_dir <- file.path(getwd(), "Processed Data/campeche/Incumbents")
...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_campeche_inafed.xlsx")
...
vote_db <- read_csv("Processed Data/campeche/campeche_vote_manipulation.csv")
...
output_path <- file.path(output_dir, "campeche_incumbent_manipulator.csv")
