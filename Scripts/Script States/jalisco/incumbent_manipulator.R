...
output_dir <- file.path(getwd(), "Processed Data/jalisco/Incumbents")
...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_jalisco_inafed.xlsx")
...
vote_db <- read_csv("Processed Data/jalisco/jalisco_vote_manipulation.csv")
...
output_path <- file.path(output_dir, "jalisco_incumbent_manipulator.csv")
