...
# Load the data
finaldb <- read_dta( "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/jalisco/jalisco_merged_IncumbentVote.dta")
...
finaldb <- finaldb %>%
  ...
  mutate(incumbent_party_magar = ifelse(year == 1997 & incumbent_party_magar == "PFCRN", "PartCardenista", incumbent_party_magar)) %>% 
  mutate(runnerup_party_magar = ifelse(year == 1997 & runnerup_party_magar == "PDM", "PD", runnerup_party_magar)) %>%
  mutate(runnerup_party_magar = ifelse(year == 1997 & runnerup_party_magar == "PFCRN", "PartCardenista", runnerup_party_magar))
...
write.csv(finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/jalisco/jalisco_FINAL_draft.csv")


#CLEAN DB
  # Select only the desired columns
  jalisco_finaldb <- finaldb %>% 
  select(
    state,
    mun,
    section,
  ...
  write.csv(jalisco_finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/jalisco/jalisco_FINAL.csv")
