...
db <- read_excel("Data/collapsed database manual cases/jalisco_collapsed_edited.xlsx")
og <- read.csv("Processed Data/jalisco/jalisco_vote_calculator.csv")
...
output_path <- file.path(output_dir, "jalisco_final.csv")
