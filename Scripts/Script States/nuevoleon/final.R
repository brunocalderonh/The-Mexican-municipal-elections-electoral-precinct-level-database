...
db <- read_excel("nuevoleon/nuevoleon_collapsed_edited.xlsx")
og <- read.csv("nuevoleon/nuevoleon_FINAL_draft.csv")
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/nuevoleon/nuevoleon_FINALV.csv")
