...
db <- read_excel("Data/collapsed database manual cases/nuevoleon_collapsed_edited.xlsx")
og <- read.csv("Processed Data/nuevoleon/nuevoleon_FINAL_draft.csv")
...
output_path <- file.path(output_dir, "nuevoleon_FINALV.csv")
