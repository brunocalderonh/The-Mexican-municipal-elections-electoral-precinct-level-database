...
# Load the data
finaldb <- read_dta( "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/nuevoleon/nuevoleon_merged_IncumbentVote.dta")
...
write.csv(finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/nuevoleon/nuevoleon_FINAL_draft.csv")


#CLEAN DB
  # Select only the desired columns
  nuevoleon_finaldb <- finaldb %>% 
  select(
    state,
    mun,
    section,
  ...
  write.csv(nuevoleon_finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/nuevoleon/nuevoleon_FINAL.csv")
