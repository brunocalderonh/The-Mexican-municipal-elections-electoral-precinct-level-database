...
output_dir <- file.path(getwd(), "Processed Data/nuevoleon/Incumbents")
...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_nuevoleon_inafed.xlsx")
...
vote_db <- read_csv("Processed Data/nuevoleon/nuevoleon_vote_manipulation.csv")
...
output_path <- file.path(output_dir, "nuevoleon_incumbent_manipulator.csv")
