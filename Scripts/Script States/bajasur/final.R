...
db <- read_excel("Data/collapsed database manual cases/bajasur_collapsed_edited.xlsx")
og <- read.csv("Processed Data/bajasur/bajasur_FINAL_draft.csv")
...
output_path <- file.path(output_dir, "bajasur_FINALV.csv")
