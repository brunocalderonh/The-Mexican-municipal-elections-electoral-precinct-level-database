...
# Load the data
finaldb <- read_dta( "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/bajasur/bajasur_merged_IncumbentVote.dta")
...
replace_parties <- function(party_str, year) {
  ...
  # Handle CONVE separately based on the year
  if (year >= 2011) {
    party_str <- str_replace_all(party_str, "CONVE", "MC")
  } else {
    party_str <- str_replace_all(party_str, "CONVE", "PC")
  }
...
write.csv(finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/bajasur/bajasur_FINAL_draft.csv")


#CLEAN DB
  # Select only the desired columns
  bajasur_finaldb <- finaldb %>% 
  select(
    state,
    mun,
    section,
  ...
  write.csv(bajasur_finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/bajasur/bajasur_FINAL.csv")
