...
db <- read_excel("tlaxcala/tlaxcala_collapsed_edited.xlsx")
og <- read.csv("tlaxcala/tlaxcala_FINAL_draft.csv")
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/tlaxcala/tlaxcala_FINALV.csv")
