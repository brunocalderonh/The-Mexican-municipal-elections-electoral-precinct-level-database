...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_nayarit_inafed.xlsx")
...
vote_db <- read_csv("Processed Data/nayarit/nayarit_vote.csv")
...
output_path <- file.path(output_dir, "nayarit_merged_IncumbentVote.csv")
