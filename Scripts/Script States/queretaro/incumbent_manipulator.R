...
output_dir <- file.path(getwd(), "Processed Data/queretaro/Incumbents")
...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_queretaro_inafed.xlsx")
...
vote_db <- read_csv("Processed Data/queretaro/queretaro_vote_manipulation.csv")
...
output_path <- file.path(output_dir, "queretaro_incumbent_manipulator.csv")
