...
db <- read_excel("colima/colima_collapsed_edited.xlsx")
og <- read.csv("colima/colima_FINAL_draft.csv")
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/colima/colima_FINALV.csv")
