...
# Load the data
finaldb <- read_dta( "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/chiapas/chiapas_merged_IncumbentVote.dta")
...
write.csv(finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/chiapas/chiapas_FINAL_draft.csv")



#CLEAN DB
  # Select only the desired columns
  chiapas_finaldb <- finaldb %>% 
  select(
    state,
    mun,
    section,
  ...
  write.csv(chiapas_finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/chiapas/chiapas_FINAL.csv")
