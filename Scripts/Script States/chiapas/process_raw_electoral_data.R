...
collapsed_1995 <- collapsed_1995 %>%
  dplyr::mutate(uniqueid = case_when(
    ...
    municipality == 71 ~ 7071,
    municipality == 72 ~ 7072,
    municipality == 73 ~ 7073,
    municipality == 74 ~ 7074,
    municipality == 75 ~ 7075,
    municipality == 76 ~ 7076,
    municipality == 77 ~ 7077,
    municipality == 78 ~ 7078,
    municipality == 79 ~ 7079,
    municipality == 80 ~ 7080,
    municipality == 81 ~ 7081,
    municipality == 82 ~ 7082,
    municipality == 83 ~ 7083,
    municipality == 84 ~ 7084,
    municipality == 85 ~ 7085,
    municipality == 86 ~ 7086,
    municipality == 87 ~ 7087,
    municipality == 88 ~ 7088,
    municipality == 89 ~ 7089,
    municipality == 90 ~ 7090,
    municipality == 91 ~ 7091,
    municipality == 92 ~ 7092,
    municipality == 93 ~ 7093,
    municipality == 94 ~ 7094,
    municipality == 95 ~ 7095,
    municipality == 96 ~ 7096,
    municipality == 97 ~ 7097,
    municipality == 98 ~ 7098,
    municipality == 99 ~ 7099,
    municipality == 100 ~ 7100,
    municipality == 101 ~ 7101,
    municipality == 102 ~ 7102,
