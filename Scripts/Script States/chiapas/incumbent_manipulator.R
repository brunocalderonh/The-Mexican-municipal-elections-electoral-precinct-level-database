...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_chiapas_inafed.xlsx")
...
vote_db <- read_csv("Processed Data/chiapas/chiapas_vote.csv")
...
output_path <- file.path(output_dir, "chiapas_merged_IncumbentVote.csv")
