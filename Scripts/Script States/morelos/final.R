...
db <- read_excel("morelos/morelos_collapsed_edited.xlsx")
og <- read.csv("morelos/morelos_FINAL_draft.csv")
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/morelos/morelos_FINALV.csv")
