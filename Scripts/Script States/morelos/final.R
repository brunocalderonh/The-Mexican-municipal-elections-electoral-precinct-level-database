...
db <- read_excel("Data/collapsed database manual cases/morelos_collapsed_edited.xlsx")
og <- read.csv("Processed Data/morelos/morelos_vote_calculator.csv")
...
output_path <- file.path(output_dir, "morelos_final.csv")
