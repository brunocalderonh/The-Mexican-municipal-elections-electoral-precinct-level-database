...
output_dir <- file.path(getwd(), "Processed Data/quintanaroo/Incumbents")
...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_quintanaroo_inafed.xlsx")
...
vote_db <- read_csv("Processed Data/quintanaroo/quintanaroo_vote_manipulation.csv")
...
output_path <- file.path(output_dir, "quintanaroo_incumbent_manipulator.csv")
