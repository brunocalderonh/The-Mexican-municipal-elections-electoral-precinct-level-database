...
db <- read_excel("Data/collapsed database manual cases/quintanaroo_collapsed_edited.xlsx")
og <- read.csv("Processed Data/quintanaroo/quintanaroo_vote_calculator.csv")
...
output_path <- file.path(output_dir, "quintanaroo_final.csv")
