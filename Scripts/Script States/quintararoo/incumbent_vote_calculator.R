...
# Load the data
finaldb <- read_dta( "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/quintanaroo/quintanaroo_merged_IncumbentVote.dta")
...
write.csv(finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/quintanaroo/quintanaroo_FINAL_draft.csv")



#CLEAN DB
  # Select only the desired columns
  quintanaroo_finaldb <- finaldb %>% 
  select(
    state,
    mun,
    section,
  ...
  write.csv(quintanaroo_finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/quintanaroo/quintanaroo_FINAL.csv")
