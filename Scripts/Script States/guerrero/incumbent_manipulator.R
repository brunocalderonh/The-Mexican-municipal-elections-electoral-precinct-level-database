...
output_dir <- file.path(getwd(), "Processed Data/guerrero/Incumbents")
...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_guerrero_inafed.xlsx")
...
vote_db <- read_csv("Processed Data/guerrero/guerrero_vote_manipulation.csv", 
                    col_types = cols(PAN_PRD = col_double(), PRD_MC = col_character()))
...
output_path <- file.path(output_dir, "guerrero_incumbent_manipulator.csv")
