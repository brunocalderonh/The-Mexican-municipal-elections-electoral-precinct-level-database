...
finaldb <- read_csv("Processed Data/guerrero/guerrero_incumbent_manipulator.csv")
    ...
    if (str_detect(incumbent_party, "_")) {
      ...
      for (party in parties) {
        if (party %in% data$incumbent_party_JL[I] || 
            ...
            party %in% data$incumbent_party_magar[I]) {
...
output_dir <- file.path(getwd(), "Processed Data/guerrero")
output_path <- file.path(output_dir, "guerrero_vote_calculator.csv")
