...
# Load the data
finaldb <- read_dta( "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/guerrero/guerrero_merged_IncumbentVote.dta")
...
write.csv(finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/guerrero/guerrero_FINAL_draft.csv")


#CLEAN DB
  # Select only the desired columns
  guerrero_finaldb <- finaldb %>% 
  select(
    state,
    mun,
    section,
  ...
  write.csv(guerrero_finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/guerrero/guerrero_FINAL.csv")
