...
db <- read_excel("Data/collapsed database manual cases/guerrero_collapsed_edited.xlsx")
og <- read.csv("Processed Data/guerrero/guerrero_vote_calculator.csv")
...
output_path <- file.path(output_dir, "guerrero_final.csv")
