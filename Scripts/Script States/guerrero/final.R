...
db <- read_excel("guerrero/guerrero_collapsed_edited.xlsx")
og <- read.csv("guerrero/guerrero_FINAL_draft.csv")
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/guerrero/guerrero_FINALV.csv")
