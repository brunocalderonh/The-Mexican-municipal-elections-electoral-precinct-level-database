...
output_dir <- file.path(getwd(), "Processed Data/veracruz/Incumbents")
...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_veracruz_inafed.xlsx")
...
vote_db <- read_csv("Processed Data/veracruz/veracruz_vote_manipulation.csv")
...
output_path <- file.path(output_dir, "veracruz_incumbent_manipulator.csv")
