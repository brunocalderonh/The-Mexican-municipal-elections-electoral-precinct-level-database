...
db <- read_excel("Data/collapsed database manual cases/veracruz_collapsed_edited.xlsx")
og <- read.csv("Processed Data/veracruz/veracruz_vote_calculator.csv")
...
output_path <- file.path(output_dir, "veracruz_final.csv")
