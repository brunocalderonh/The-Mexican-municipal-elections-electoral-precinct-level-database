...
db <- read_excel("veracruz/veracruz_collapsed_edited.xlsx")
og <- read.csv("veracruz/veracruz_FINAL_draft.csv")
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/veracruz/veracruz_FINALV.csv")
