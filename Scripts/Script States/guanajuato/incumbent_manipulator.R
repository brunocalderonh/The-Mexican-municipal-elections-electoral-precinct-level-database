...
output_dir <- file.path(getwd(), "Processed Data/guanajuato/Incumbents")
...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_guanajuato_inafed.xlsx")
