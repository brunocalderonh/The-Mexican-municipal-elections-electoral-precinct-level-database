...
db <- read_excel("Data/collapsed database manual cases/guanajuato_collapsed_edited.xlsx")
og <- read.csv("Processed Data/guanajuato/guanajuato_vote_calculator.csv")
...
output_path <- file.path(output_dir, "guanajuato_final.csv")
