...
db <- read_excel("guanajuato/guanajuato_collapsed_edited.xlsx")
og <- read.csv("guanajuato/guanajuato_FINAL_draft.csv")
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/guanajuato/guanajuato_FINALV.csv")
