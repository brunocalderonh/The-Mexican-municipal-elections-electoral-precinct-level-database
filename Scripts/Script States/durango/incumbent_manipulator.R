...
write_dta(mag_db, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/durango/Incumbents/incumbent_magar.dta")


#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("incumbent INAFED/incumbents_durango_inafed.xlsx")
...
# Add new municipalities to mun_mapping
mun_mapping$New_Municipio <- unique_municipios_inafed


max_length <- max(length(unique_municipios_mag), length(unique_municipios_inafed))

mun_mapping <- data.frame(
  Municipio = c(unique_municipios_mag, rep(NA, max_length - length(unique_municipios_mag))),
  New_Municipio = c(unique_municipios_inafed, rep(NA, max_length - length(unique_municipios_inafed)))
)
...
write_dta(inafed_db, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/durango/Incumbents/incumbent_inafed.dta")
...
write_dta(jl_db, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/durango/Incumbents/incumbent_JL.dta")
...
write_dta(horacio_db, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/durango/Incumbents/incumbent_horacio.dta")
...
write_dta(merged_incumbent_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/durango/Incumbents/incumbent_data_merged.dta")

#### MERGE INTO FINAL DB - INCUMBENT + VOTE ####
setwd("/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/durango/")

#vote_db <- read_dta("durango_vote.dta")
vote_db <- read_dta("durango_vote.dta")
...
#write_dta(final_merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/durango/durango_merged_IncumbentVote.dta")
write_dta(final_merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/durango/durango_merged_IncumbentVote.dta")
