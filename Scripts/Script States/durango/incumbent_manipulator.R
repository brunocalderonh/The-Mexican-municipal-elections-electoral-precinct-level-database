...
output_dir <- file.path(getwd(), "Processed Data/durango/Incumbents")
...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_durango_inafed.xlsx")
...
vote_db <- read_csv("Processed Data/durango/durango_vote_manipulation.csv")
...
output_path <- file.path(output_dir, "durango_incumbent_manipulator.csv")
