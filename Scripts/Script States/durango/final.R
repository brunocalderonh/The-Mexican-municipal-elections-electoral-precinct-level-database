...
db <- read_excel("Data/collapsed database manual cases/durango_collapsed_edited.xlsx")
og <- read.csv("Processed Data/durango/durango_vote_calculator.csv")
...
output_path <- file.path(output_dir, "durango_final.csv")
