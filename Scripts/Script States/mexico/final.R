...
db <- read_excel("Data/collapsed database manual cases/mexico_collapsed_edited.xlsx")
og <- read.csv("Processed Data/mexico/mexico_vote_calculator.csv")
...
output_path <- file.path(output_dir, "mexico_final.csv")
