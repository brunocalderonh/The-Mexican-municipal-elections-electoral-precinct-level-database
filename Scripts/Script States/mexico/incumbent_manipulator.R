...
output_dir <- file.path(getwd(), "Processed Data/mexico/Incumbents")
...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_mexico_inafed.xlsx")
...
vote_db <- read_csv("Processed Data/mexico/mexico_vote_manipulation.csv")
...
output_path <- file.path(output_dir, "mexico_incumbent_manipulator.csv")
