...
finaldb <- read_csv("Processed Data/sonora/sonora_incumbent_manipulator.csv")
...
output_dir <- file.path(getwd(), "Processed Data/sonora")
output_path <- file.path(output_dir, "sonora_vote_calculator.csv")
