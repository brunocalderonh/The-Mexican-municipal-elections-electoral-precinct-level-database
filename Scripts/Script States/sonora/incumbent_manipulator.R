...
output_dir <- file.path(getwd(), "Processed Data/sonora/Incumbents")
...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_sonora_inafed.xlsx")
...
vote_db <- read_csv("Processed Data/sonora/sonora_vote_manipulation.csv")
...
output_path <- file.path(output_dir, "sonora_incumbent_manipulator.csv")
