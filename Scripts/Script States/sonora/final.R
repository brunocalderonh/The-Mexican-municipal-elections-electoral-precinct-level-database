...
db <- read_excel("sonora/sonora_collapsed_edited.xlsx")
og <- read.csv("sonora/sonora_FINAL_draft.csv")
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/sonora/sonora_FINALV.csv")
