...
db <- read_excel("Data/collapsed database manual cases/sonora_collapsed_edited.xlsx")
og <- read.csv("Processed Data/sonora/sonora_vote_calculator.csv")
...
output_path <- file.path(output_dir, "sonora_final.csv")
