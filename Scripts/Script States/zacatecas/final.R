...
db <- read_excel("zacatecas/zacatecas_collapsed_edited.xlsx")
og <- read.csv("zacatecas/zacatecas_FINAL_draft.csv")
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/zacatecas/zacatecas_FINALV.csv")
