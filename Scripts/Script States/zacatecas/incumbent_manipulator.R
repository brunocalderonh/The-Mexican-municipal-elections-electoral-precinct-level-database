...
output_dir <- file.path(getwd(), "Processed Data/zacatecas/Incumbents")
...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_zacatecas_inafed.xlsx")
...
vote_db <- read_csv("Processed Data/zacatecas/zacatecas_vote.csv")
...
output_path <- file.path(output_dir, "zacatecas_merged_IncumbentVote.csv")
