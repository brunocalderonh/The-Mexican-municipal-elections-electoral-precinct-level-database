...
db <- read_excel("Data/collapsed database manual cases/oaxaca_collapsed_edited.xlsx")
og <- read.csv("Processed Data/oaxaca/oaxaca_FINAL_draft.csv")
...
output_path <- file.path(output_dir, "oaxaca_FINALV.csv")
