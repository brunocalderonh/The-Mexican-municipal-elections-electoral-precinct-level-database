...
db <- read_excel("oaxaca/oaxaca_collapsed_edited.xlsx")
og <- read.csv("oaxaca/oaxaca_FINAL_draft.csv")
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/oaxaca/oaxaca_FINALV.csv")
