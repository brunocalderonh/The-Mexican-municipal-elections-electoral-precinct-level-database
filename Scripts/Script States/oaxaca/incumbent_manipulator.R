...
output_dir <- file.path(getwd(), "Processed Data/oaxaca/Incumbents")
...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_oaxaca_inafed.xlsx")
...
vote_db <- read_csv("Processed Data/oaxaca/oaxaca_vote_manipulation.csv")
...
output_path <- file.path(output_dir, "oaxaca_incumbent_manipulator.csv")
