...
output_dir <- file.path(getwd(), "Processed Data/puebla/Incumbents")
...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_puebla_inafed.xlsx")
...
vote_db <- read_csv("Processed Data/puebla/puebla_vote_manipulation.csv")
...
output_path <- file.path(output_dir, "puebla_incumbent_manipulator.csv")
