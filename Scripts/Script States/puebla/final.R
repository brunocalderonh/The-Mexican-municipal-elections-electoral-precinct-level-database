...
db <- read_excel("Data/collapsed database manual cases/puebla_collapsed_edited.xlsx")
og <- read.csv("Processed Data/puebla/puebla_vote_calculator.csv")
...
output_path <- file.path(output_dir, "puebla_final.csv")
