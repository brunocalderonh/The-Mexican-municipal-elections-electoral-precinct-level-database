...
db <- read_excel("puebla/puebla_collapsed_edited.xlsx")
og <- read.csv("puebla/puebla_FINAL_draft.csv")
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/puebla/puebla_FINALV.csv")
