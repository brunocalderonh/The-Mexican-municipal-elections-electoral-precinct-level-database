...
vote_db <- read_csv("Processed Data/aguascalientes/aguascalientes_vote_manipulation.csv")
...
output_path <- file.path(output_dir, "aguascalientes_incumbent_manipulator.csv")
