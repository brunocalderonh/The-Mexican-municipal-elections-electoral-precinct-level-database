...
db <- read_excel("Data/collapsed database manual cases/yucatans_collapsed_edited.xlsx")
og <- read.csv("Processed Data/yucatans/yucatans_FINAL_draft.csv")
...
output_path <- file.path(output_dir, "yucatan_FINALV.csv")
