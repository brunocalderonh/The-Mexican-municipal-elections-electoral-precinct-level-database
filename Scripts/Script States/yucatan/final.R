...
db <- read_excel("Data/collapsed database manual cases/yucatan_collapsed_edited.xlsx")
og <- read.csv("Processed Data/yucatan/yucatan_vote_calculator.csv")
...
output_path <- file.path(output_dir, "yucatan_final.csv")
