...
output_dir <- file.path(getwd(), "Processed Data/yucatan/Incumbents")
...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_yucatan_inafed.xlsx")
...
vote_db <- read_csv("Processed Data/yucatan/yucatan_vote_manipulation.csv")
...
output_path <- file.path(output_dir, "yucatan_incumbent_manipulator.csv")
