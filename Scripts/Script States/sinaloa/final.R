...
db <- read_excel("Data/collapsed database manual cases/sinaloa_collapsed_edited.xlsx")
og <- read.csv("Processed Data/sinaloa/sinaloa_vote_calculator.csv")
...
output_path <- file.path(output_dir, "sinaloa_final.csv")
