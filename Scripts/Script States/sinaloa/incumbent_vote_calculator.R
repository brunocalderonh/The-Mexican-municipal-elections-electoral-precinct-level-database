...
# Load the data
finaldb <- read_dta( "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/sinaloa/sinaloa_merged_IncumbentVote.dta")
...
write.csv(finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/sinaloa/sinaloa_FINAL_draft.csv")


#CLEAN DB
  # Select only the desired columns
  sinaloa_finaldb <- finaldb %>% 
  select(
    state,
    mun,
    section,
  ...
  write.csv(sinaloa_finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/sinaloa/sinaloa_FINAL.csv")
