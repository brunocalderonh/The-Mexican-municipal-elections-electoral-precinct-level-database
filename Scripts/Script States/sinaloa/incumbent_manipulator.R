...
output_dir <- file.path(getwd(), "Processed Data/sinaloa/Incumbents")
...
#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("Data/incumbent data/incumbent INAFED/incumbents_sinaloa_inafed.xlsx")
...
vote_db <- read_csv("Processed Data/sinaloa/sinaloa_vote_manipulation.csv")
...
output_path <- file.path(output_dir, "sinaloa_incumbent_manipulator.csv")
