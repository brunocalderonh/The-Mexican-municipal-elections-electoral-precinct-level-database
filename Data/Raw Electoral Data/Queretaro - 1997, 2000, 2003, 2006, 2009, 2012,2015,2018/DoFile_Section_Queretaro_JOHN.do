...
capture cd "C:\Users\jmarshall\Dropbox\Incumbency Advantage\Data Analysis\Raw Data\Precinct\Queretaro - 1997, 2000, 2003, 2006, 2009, 2012"
...
import excel Ayu_Seccion_2012.xlsx, clear firstrow case(lower)
...
replace uniqueid=22003 if municipality =="ARROYO SECO"
replace uniqueid=22004 if municipality =="CADEREYTA DE MONTES"
replace uniqueid=22005 if municipality =="COLÃ“N"
replace uniqueid=22006 if municipality =="CORREGIDORA"
replace uniqueid=22011 if municipality =="EL MARQUÃ‰S"
replace uniqueid=22007 if municipality =="EZEQUIEL MONTES"
replace uniqueid=22008 if municipality =="HUIMILPAN"
replace uniqueid=22009 if municipality =="JALPAN DE SERRA"
replace uniqueid=22010 if municipality =="LANDA DE MATAMOROS"
replace uniqueid=22012 if municipality =="PEDRO ESCOBEDO"
replace uniqueid=22013 if municipality =="PEÃ‘AMILLER"
replace uniqueid=22002 if municipality =="PINAL DE AMOLES"
replace uniqueid=22014 if municipality =="QUERÃ‰TARO"
replace uniqueid=22015 if municipality =="SAN JOAQUÃN"
replace uniqueid=22016 if municipality =="SAN JUAN DEL RÃO"
replace uniqueid=22017 if municipality =="TEQUISQUIAPAN"
replace uniqueid=22018 if municipality =="TOLIMÃN"
...
capture merge 1:m ed seccion using "C:\Users\jmarshall\Dropbox\Turismo Electoral\all_months_years.dta", keepusing(month year lista day)
...
saveold Queretaro_ALL.dta, replace version(12)
