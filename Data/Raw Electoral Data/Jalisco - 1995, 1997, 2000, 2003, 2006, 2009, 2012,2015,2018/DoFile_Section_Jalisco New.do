...
capture cd "/Users/LauT/Dropbox/Trabajos/Incumbency Advantage/Data Analysis/Raw Data/Precinct/Jalisco - 1995, 1997, 2000, 2003, 2006, 2009, 2012"
...
foreach var in PAN PRI PPS PRD Partido_Cardenista PARM PDM PT PVEM PPJ {
...
foreach var in PAN PRI PRD PT PVEM Partido_Cardenista PSN PAS ElBarzon MexicoPosible PLM FC PRD_PAS PRD_Partido_Cardenista PRD_PVEM PVEM_PAS PRD_PVEM_PAS {
...
foreach var in PAN PRI PRD_PT PVEM PC PANAL PAS {
...
foreach var in PAN PRD PT PVEM PC PSD PRI_PANAL PRD_PT PT_PC {
...
foreach var in PAN PRD PANAL PRI_PVEM PT_PC {
