capture cd "D:\Dropbox\Incumbency Advantage\Data Analysis\Raw Data\Precinct\Tabasco - 1997, 2000, 2003,2006, 2009, 2012"
...
capture rename VOTACIÓNTOTAL VOTACINTOTAL
...
replace uniqueid=27005 if municipality =="COMALCALCO"
replace uniqueid=27006 if municipality =="CUNDUACAN"
replace uniqueid=27007 if municipality =="E. ZAPATA"
replace uniqueid=27008 if municipality =="HUIMANGUILLO"
replace uniqueid=27009 if municipality =="JALAPA"
replace uniqueid=27010 if municipality =="J. DE MENDEZ"
replace uniqueid=27011 if municipality =="JONUTA"
replace uniqueid=27012 if municipality =="MACUSPANA"
replace uniqueid=27013 if municipality =="NACAJUCA"
replace uniqueid=27014 if municipality =="PARAISO"
...
replace municipality ="BALANCAN" if MUNICIPIO==1
replace uniqueid=27002  if MUNICIPIO==2
replace municipality ="CARDENAS"  if MUNICIPIO==2
...
replace municipality ="CUNDUACAN" if MUNICIPIO==7
...
replace municipality ="PARAISO" if MUNICIPIO==14
...
saveold Tabasco_ALL.dta, replace version(12)
