...
capture cd "C:\Users\Horacio\Dropbox\Incumbency Advantage\Data Analysis\Raw Data\Precinct\Tabasco - 1997, 2000, 2003,2006, 2009, 2012"
capture cd "/Users/LauT/Dropbox/Trabajos/Incumbency Advantage/Data Analysis/Raw Data/Precinct/Tabasco - 1997, 2000, 2003,2006, 2009, 2012"
...
foreach var in PAN PRI_PVEM PRD PT PC PAS PMP PFC {
...
destring listanominal  noregistrados - total , replace

collapse (sum)  listanominal  noregistrados - total , by (municipality section)
...
foreach var in PAN PRI PRD_PT PVEM PANAL PAS listanominal total valid{
bys uniqueid: egen mun_`var'= sum(`var') 
gen inv_mun_`var'= 1/mun_`var'
}
...
foreach var in PAN PRI PRD_PT PVEM PANAL PAS {
...
foreach var in PAN PRI_PANAL PRD PT PVEM PC {
...
replace municipality ="CUNDUACÁN" if MUNICIPIO==6
...
foreach var in PAN PRD_PT_PC PRI_PVEM_PANAL {
...
erase Tabasco_Section_1997.dta
erase Tabasco_Section_2000.dta
erase Tabasco_Section_2003.dta
erase Tabasco_Section_2006.dta
erase Tabasco_Section_2009.dta
erase Tabasco_Section_2012.dta
