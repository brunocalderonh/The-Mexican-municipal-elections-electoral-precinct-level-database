...
capture cd "/Users/LauT/Dropbox/Trabajos/Incumbency Advantage/Data Analysis/Raw Data/Precinct/Sonora - 1994, 1997, 2000, 2003, 2006, 2009, 2012"
...
egen valid = rowtotal(PAN PRI PPS PRD PartidoCardenista PARM PDM PT PVEM)

foreach var in PAN PRI PPS PRD PartidoCardenista PARM PDM PT PVEM total valid{
...
rowranks inv_mun_PAN inv_mun_PRI inv_mun_PPS inv_mun_PRD inv_mun_PartidoCardenista inv_mun_PARM inv_mun_PDM inv_mun_PT inv_mun_PVEM, gen(PAN_r PRI_r PPS_r PRD_r PartidoCardenista_r PARM_r PDM_r PT_r PVEM_r)
drop inv_mun_*
...
foreach var in PAN PRI PPS PRD PartidoCardenista PARM PDM PT PVEM {
...
foreach var in PAN PRI PRD PartidoCardenista PT PVEM PPS PDM {
...
foreach var in PAN PRI PRD PVEM PT PAS PFC PC PMP PSN PAN_PRD PRI_PVEM PRD_PT_PC PAS_PMP PRD_PC_PAS PSN_PAS PRD_PT {
...
foreach var in PAN PRI PRI_PANAL PRD_PT PVEM PC PAS {
...
foreach var in PAN PRI PRD PT PVEM PC PSD PRI_PVEM_PANAL {
...
foreach var in PAN PRI PRD PT PVEM PC PANAL PAN_PANAL PRI_PVEM PRD_PT PRD_PC PRD_PT_PC {
