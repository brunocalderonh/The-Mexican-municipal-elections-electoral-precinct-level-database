capture cd "D:\Dropbox\Incumbency Advantage\Data Analysis\Raw Data\Precinct\Hidalgo - 1996, 1999, 2002, 2005, 2008, 2011"
capture cd "C:\Users\Horacio\Dropbox\Incumbency Advantage\Data Analysis\Raw Data\Precinct\Hidalgo - 1996, 1999, 2002, 2005, 2008, 2011"
capture cd "/Users/LauT/Dropbox/Trabajos/Incumbency Advantage/Data Analysis/Raw Data/Precinct/Hidalgo - 1996, 1999, 2002, 2005, 2008, 2011"
...
foreach var in PAN PRI PartCardenista PRD PT PVEM total listanominal valid{
...
rowranks inv_mun_PAN inv_mun_PRI inv_mun_PartCardenista inv_mun_PRD inv_mun_PT inv_mun_PVEM, gen(PAN_r PRI_r PartCardenista_r PRD_r PT_r PVEM_r)
drop inv_mun_*
...
foreach var in PAN PRI PartCardenista PRD PT PVEM {
...
foreach var in PAN PRI PRD PT PVEM PSN PC PAS PRI_PVEM {
...
import delimited using Ayu_Seccion_2005.csv, clear
...
foreach var in PAN PRI PRD PT PVEM PC PAS {
...
* EL TRIBUNAL ANUL� LA ELECCI�N CONVOCANDO A ELECCION EXTRAORDINARIA EL DIA 5 JULIO 2009
drop if municipality=="HUAZALINGO" | municipality=="ZIMAPAN"
* EL TRIBUNAL DECRETO UN EMPATE CONVOCANDO A ELECCI�N EXTRAORDINARIA EL DIA 5 JULIO 2009
...
foreach var in PAN PRI PRD PT PVEM PC PSD PANAL PRI_PANAL PRD_PT {
...
* ANULADA LA ELECCION POR EL TEPJF, CONVOCANDO A ELECCI�N EXTRAORDINARIA EL DIA 18 MARZO 2012
...
foreach var in PAN PRI PRD PT PVEM PC PANAL PAN_PRD PT_PC PRI_PVEM {
