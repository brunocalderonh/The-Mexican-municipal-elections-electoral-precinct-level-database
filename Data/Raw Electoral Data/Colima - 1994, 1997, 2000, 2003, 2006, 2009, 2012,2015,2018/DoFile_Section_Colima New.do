...
capture cd "/Users/LauT/Dropbox/Trabajos/Incumbency Advantage/Data Analysis/Raw Data/Precinct/Colima - 1994, 1997, 2000, 2003, 2006, 2009, 2012"
...
foreach var in PAN PRI PPS PRD Partido_Cardenista PDM PRT PT {
...
foreach var in PAN PRI PRD Partido_Cardenista PT PVEM PPS PDM {
...
foreach var in PAN PRI PRD PVEM PDS ADC PAN_PRD {
...
foreach var in PAN PRI PRD PT PVEM PC PSN PAS ADC MexicoPosible FuerzaCiudadana {
...
foreach var in PAN PRI_PVEM PRD_ADC PT_PC PAS {
...
foreach var in PAN_ADC PT PVEM PC PRI_PANAL PRD_PSD {
...
foreach var in PAN PRI_PANAL PRD PT PVEM PC ADC {
