...
capture cd "C:\Users\johnlouismarshall\Dropbox\Incumbency Advantage\Data Analysis\Raw Data\Precinct\Colima - 1994, 1997, 2000, 2003, 2006, 2009, 2012"
...
egen valid = rowtotal(PAN PRI PPS PRD Partido_Cardenista PDM PRT PT)

foreach var in PAN PRI PPS PRD Partido_Cardenista PDM PRT PT total valid{
...
g ed = 6
g sec = section
capture merge 1:m ed sec using "D:\Dropbox\Incumbency Advantage\Data Analysis\Raw Data\Precinct\Nationwide Listanominal 1994.dta", keepusing(lista)
capture merge 1:m ed sec using "C:\Users\johnlouismarshall\Dropbox\Incumbency Advantage\Data Analysis\Raw Data\Precinct\Nationwide Listanominal 1994.dta", keepusing(lista)
capture merge 1:m ed sec using "C:\Users\Horacio\Dropbox\Incumbency Advantage\Data Analysis\Raw Data\Precinct\Nationwide Listanominal 1994.dta", keepusing(lista)
drop if _merge==2
drop _merge
...
rowranks inv_mun_PAN inv_mun_PRI inv_mun_PPS inv_mun_PRD inv_mun_Partido_Cardenista inv_mun_PDM inv_mun_PRT inv_mun_PT, gen(PAN_r PRI_r PPS_r PRD_r Partido_Cardenista_r PDM_r PRT_r PT_r)
drop inv_mun_*
...
foreach var in PAN PRI PRD Partido_Cardenista PT PVEM PPS PDM total listanominal valid{
bys uniqueid: egen mun_`var'= sum(`var') 
gen inv_mun_`var'= 1/mun_`var'
}
...
capture merge 1:m ed seccion using "D:\Dropbox\Turismo Electoral\all_months_years.dta", keepusing(month year lista)
capture merge 1:m ed seccion using "C:\Users\johnlouismarshall\Dropbox\Turismo Electoral\all_months_years.dta", keepusing(month year lista)
...
rename fuerzaciudadana FuerzaCiudadana
...
egen valid = rowtotal(PAN PRI PRD PT PVEM PC PSN PAS ADC MexicoPosible FuerzaCiudadana)

foreach var in PAN PRI PRD PT PVEM PC PSN PAS ADC MexicoPosible FuerzaCiudadana total listanominal valid{
bys uniqueid: egen mun_`var'= sum(`var') 
gen inv_mun_`var'= 1/mun_`var'
}
...
rowranks inv_mun_PAN inv_mun_PRI inv_mun_PRD inv_mun_PT inv_mun_PVEM inv_mun_PC inv_mun_PSN inv_mun_PAS inv_mun_ADC inv_mun_MexicoPosible inv_mun_FuerzaCiudadana, gen(PAN_r PRI_r PRD_r PT_r PVEM_r PC_r PSN_r PAS_r ADC_r MexicoPosible_r FuerzaCiudadana_r)
drop inv_mun_*
...
replace winner = "FuerzaCiudadana" if FuerzaCiudadana_r==1
drop *_r
...
g ed = 6
g seccion = section
capture merge 1:m ed seccion using "C:\Users\Horacio\Dropbox\Turismo Electoral\all_months_years.dta", keepusing(month year lista day)
capture merge 1:m ed seccion using "D:\Dropbox\Turismo Electoral\all_months_years.dta", keepusing(month year lista day)
capture merge 1:m ed seccion using "C:\Users\johnlouismarshall\Dropbox\Turismo Electoral\all_months_years.dta", keepusing(month year lista day)
...
capture cd "D:\Dropbox\Incumbency Advantage\Data Analysis\Raw Data\Precinct"
capture cd "D:\Dropbox\Incumbency Advantage\Data Analysis\Raw Data\Precinct"
