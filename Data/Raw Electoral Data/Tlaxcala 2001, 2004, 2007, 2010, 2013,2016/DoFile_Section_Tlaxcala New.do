...
capture cd "/Users/LauT/Dropbox/Trabajos/Incumbency Advantage/Data Analysis/Raw Data/Precinct/Tlaxcala 2001, 2004, 2007, 2010, 2013"
...
foreach var in PRI PAN PRD PT PVEM Partido_Democrata PSN PC PAS PCDT PJS {
...
foreach var in PAN PRI PRD PT PVEM PC PCDT PJS PRI_PVEM PT_PCDT_PJS PCDT_PJS PT_PCDT PT_PJS {
...
foreach var in PRI PAN_PAC PRI_PVEM PRD PT PVEM PC PCDT PANAL PAS PS PRI_PVEM_PS total valid{
bys uniqueid: egen mun_`var'= sum(`var') 
gen inv_mun_`var'= 1/mun_`var'
}
...
foreach var in PRI PAN_PAC PRI_PVEM PRD PT PVEM PC PCDT PANAL PAS PS PRI_PVEM_PS {
...
drop listanominal turnout 
*drop mun_listanominal mun_turnout
...
foreach var in PAN_PANAL PRI PRI_PVEM PRI_PST PRD PRD_PT_PC PRD_PC PRD_PT PT PT_PC PVEM PC PST PAC PP PLT PPT {
...
foreach var in PAN PRI PRD PT PVEM PC PANAL PAC PS PAC_PS PAN_PAC PRD_PT PRI_PVEM PT_PAC {
