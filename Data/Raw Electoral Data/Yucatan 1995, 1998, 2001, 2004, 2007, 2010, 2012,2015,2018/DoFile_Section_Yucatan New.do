...
capture cd "/Users/LauT/Dropbox/Trabajos/Incumbency Advantage/Data Analysis/Raw Data/Precinct/Yucatan 1995, 1998, 2001, 2004, 2007, 2010, 2012"
...
egen valid = rowtotal(PAN PRI PRD PartidoCardenista PT PVEM Otros)

foreach var in PAN PRI PRD PartidoCardenista PT PVEM Otros listanominal total valid{
...
rowranks inv_mun_PAN inv_mun_PRI inv_mun_PRD inv_mun_PartidoCardenista inv_mun_PT inv_mun_PVEM inv_mun_Otros, gen(PAN_r PRI_r PRD_r PartidoCardenista_r PT_r PVEM_r Otros_r)
drop inv_mun_*
...
foreach var in PAN PRI PRD PartidoCardenista PT PVEM Otros {
...
foreach var in PAN PRI PRI_PVEM PRD PT PVEM PC PY PAY {
...
foreach var in PAN PRI PRD PVEM PAY PANAL PAS CI PT_PC {
...
foreach var in PAN PRI PRD PT PVEM PC PAY PANAL PRI_PVEM {
...
foreach var in PAN PRI PRD PT PVEM MC PANAL PSDYUC PRI_PVEM PRI_PVEM_PSD PRD_MC PT_PRD_MC PT_PRD_PSD PT_PRD PT_MC {
...
foreach var in PRI PRD PT PCP PVEM PANAL PD PSD PAS PSN PartidoCardenista  CDPPN PUP PEC PFC PAC PJS PST PRV PY PAY CI MC {
gen `var'_winner =0
