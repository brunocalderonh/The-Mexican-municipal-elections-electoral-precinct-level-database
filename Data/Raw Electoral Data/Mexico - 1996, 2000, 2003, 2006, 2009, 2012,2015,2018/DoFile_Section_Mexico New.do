...
capture cd "/Users/LauT/Dropbox/Trabajos/Incumbency Advantage/Data Analysis/Raw Data/Precinct/Mexico - 1996, 2000, 2003, 2006, 2009, 2012"
...
egen valid = rowtotal(PAN PRI PRD Partido_Cardenista PVEM PT PPS PDM PPM)

foreach var in PAN PRI PRD Partido_Cardenista PVEM PT PPS PDM PPM total valid{
...
rowranks inv_mun_PAN inv_mun_PRI inv_mun_PRD inv_mun_Partido_Cardenista inv_mun_PVEM inv_mun_PT inv_mun_PPS inv_mun_PDM inv_mun_PPM, gen(PAN_r PRI_r PRD_r Partido_Cardenista_r PVEM_r PT_r PPS_r PDM_r PPM_r)
drop inv_mun_*
...
foreach var in PAN PRI PRD Partido_Cardenista PVEM PT PPS PDM PPM {
...
foreach var in PAN PRI PRD PT PVEM PC PCD PSN PARM PAS PDS {
...
foreach var in PAN PRI_PVEM PRD PT PC PSN PAS PCEM {
...
replace dummy_prd_pt = 1 if municipality=="ALMOLOYA DE ALQUISIRAS" | municipality=="ALMOLOYA DE JUAREZ" | municipality=="ATIZAPAN" | municipality=="COATEPEC HARINAS" | municipality=="COYOTEPEC" | municipality=="CHICOLOAPAN" | municipality=="CHIMALHUACAN" | municipality=="ECATEPEC" | municipality=="HUIXQUILUCAN" | municipality=="IXTAPAN DE LA SAL" | municipality=="JIQUIPILCO" | municipality=="METEPEC" | municipality=="MEXICALTZINGO" | municipality=="NAUCALPAN" | municipality=="NOPALTEPEC" | municipality=="OCUILAN" | municipality=="OTZOLOAPAN" | municipality=="SAN SIMON DE GUERRERO" | municipality=="TEPETLAOXTOC" | municipality=="TEPOTZOTLAN" | municipality=="TEZOYUCA" | municipality=="TLALNEPANTLA" | municipality=="TONATICO" | municipality=="TULTEPEC" | municipality=="TULTITLAN" | municipality=="VILLA GUERRERO" | municipality=="ZACUALPAN"
...
replace dummy_pt_pc = 1 if municipality=="ACULCO" | municipality=="APAXCO" | municipality=="ATLACOMULCO" | municipality=="CHIAUTLA" | municipality=="ECATZINGO" | municipality=="IXTAPALUCA" | municipality=="XALATLACO" | municipality=="JILOTEPEC" | municipality=="LERMA" | municipality=="MALINALCO" | municipality=="OTUMBA" | municipality=="LA PAZ" | municipality=="POLOTITLAN" | municipality=="SAN MARTIN DE LAS PIRAMIDE" | municipality=="SOYANIQUILPAN DE JUAREZ" | municipality=="SULTEPEC" | municipality=="TEQUIXQUIAC" | municipality=="TEXCALYACAC" | municipality=="TIANGUISTENCO" | municipality=="TIMILPAN" | municipality=="TOLUCA" | municipality=="ZUMPAHUACAN" | municipality=="TONANITLA"
...
foreach var in PAN PRI_PVEM PRD PT PC PAN_PC PAN_PRD PAN_PRD_PT PAN_PRD_PT_PC PAN_PT PRD_PC PRD_PT PRD_PT_PC PT_PC {
...
foreach var in PAN PRD PT PC PAN_PC PRI_PVEM_PANAL_PSD_PFD PRD_PT PT_PC {
...
foreach var in PAN PRI_PVEM_PANAL PRD PT PC PRD_PT_PC PRD_PT PRD_PC PT_PC {
