...
capture cd "/Users/LauT/Dropbox/Trabajos/Incumbency Advantage/Data Analysis/Raw Data/Precinct/Guerrero - 1996, 1999, 2002, 2005, 2008, 2012"
...
foreach var in PAN PRI PPS PRD Part_Card PRT PVEM PT Part_Card_PPS PRD_Part_Card_PPS PRD_Part_Card PRD_Part_Card_PRT PRD_Part_Card_PVEM_PT {
...
foreach var in PAN PRI PRD PT PVEM PRS {
...
foreach var in PAN PRI_PVEM PRD PT PRS PC PSN PAS PSM PRD_PT {
...
foreach var in PAN PRI PRD PT PVEM PRS PC PRD_PRS {
...
foreach var in PAN PRI PRD PT PVEM PC PANAL PAS PAG PRI_PVEM PT_PC {
...
foreach var in PAN PRI PRD PT PVEM PC PANAL PRI_PVEM PRD_PT_PC {
