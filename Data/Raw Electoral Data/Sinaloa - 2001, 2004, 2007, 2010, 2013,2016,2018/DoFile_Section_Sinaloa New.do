...
capture cd "/Users/LauT/Dropbox/Trabajos/Incumbency Advantage/Data Analysis/Raw Data/Precinct/Sinaloa - 2001, 2004, 2007, 2010, 2013"
...
foreach var in PAN PRI PRD PT PVEM PC PSN PAS PBS PAN_PRD_PVEM PAN_PVEM PRD_PT PT_PSN PSN_PBS PT_PAS_PC_PSN PRD_PC PAN_PRD PT_PBS PAN_PRD_PT_PVEM PT_PC_PSN PRD_PVEM PT_PC_PBS total valid{
...
foreach var in PAN PRI PRD PT PVEM PC PSN PAS PBS PAN_PRD_PVEM PAN_PVEM PRD_PT PT_PSN PSN_PBS PT_PAS_PC_PSN PRD_PC PAN_PRD PT_PBS PAN_PRD_PT_PVEM PT_PC_PSN PRD_PVEM PT_PC_PBS {
...
foreach var in PAN PRI PRD PT PVEM PC PBS PRD_PT PRD_PT_PBS PRD_PBS PAN_PRD PRI_PVEM_PBS PRD_PT_PC {
...
foreach var in PAN PRI_PANAL PRD PT PVEM PC PAS PRI_PRD_PANAL PRD_PT_PC PRD_PT PRI_PC_PANAL PT_PAS {
...
foreach var in PAN_PRD_PT_PC PRI_PVEM_PANAL {
...
foreach var in PAN_PRD_PT PRI_PVEM_PANAL PAS PC PRI_PVEM_PANAL_PAS {
