...
capture cd "C:\Users\Horacio\Dropbox\Incumbency Advantage\Precinct\Nuevo Leon - 2000, 2003, 2006, 2009, 2012"
...
replace winner = "PRD_PC_PPN_PSN_PAS" if PRD_PC_PPN_PSN_PAS_r ==1
...
gen winner = "PAN" if PAN_r==1  
replace winner = "PRI_PVEM_PLM_FC" if PRI_PVEM_PLM_FC_r ==1
replace winner = "PRI_PT_PVEM_PLM_FC" if PRI_PT_PVEM_PLM_FC_r ==1
...
replace winner = "PC" if PC_r==1
replace winner = "PartidoRepublicano" if PartidoRepublicano_r==1
replace winner = "PAS" if PAS_r==1
...
gen winner = "PAN" if PAN_r==1  
replace winner = "PRI_PVEM_PD_CC" if PRI_PVEM_PD_CC_r ==1
replace winner = "PRD" if PRD_r==1
