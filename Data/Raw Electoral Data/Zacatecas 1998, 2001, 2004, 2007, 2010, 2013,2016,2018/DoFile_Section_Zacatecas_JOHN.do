...
capture cd "C:\Users\jmarshall\Dropbox\Incumbency Advantage\Data Analysis\Raw Data\Precinct\Zacatecas 1998, 2001, 2004, 2007, 2010, 2013"
...
replace uniqueid=32006 if strpos(municipality, "TAS DE F. PESCADOR")>0
...
replace uniqueid=32006 if strpos(municipality, "CA")>0 & strpos(municipality, "ITAS")>0
replace uniqueid=32009 if municipality =="CHALCHIHUITES"
replace uniqueid=32007 if municipality =="CONCEPCION DEL ORO"
replace uniqueid=32008 if municipality =="CUAUHTEMOC"
...
saveold Zacatecas_ALL.dta, replace version(12)

cd "C:\Users\jmarshall\Dropbox\Incumbency Advantage\Data Analysis\Raw Data\Precinct"
cd "C:\Users\jmarshall\Dropbox\Incumbency Advantage\Data Analysis\Raw Data\Precinct"
