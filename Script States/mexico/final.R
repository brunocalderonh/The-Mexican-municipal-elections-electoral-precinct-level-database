...
db <- read_excel("mexico/mexico_collapsed_edited.xlsx")
og <- read.csv("mexico/mexico_FINAL_draft.csv")
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/mexico/mexico_FINALV.csv")
