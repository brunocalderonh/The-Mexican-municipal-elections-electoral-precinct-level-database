...
db <- read_excel("queretaro/queretaro_collapsed_edited.xlsx")
og <- read.csv("queretaro/queretaro_FINAL_draft.csv")
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/queretaro/queretaro_FINALV.csv")
