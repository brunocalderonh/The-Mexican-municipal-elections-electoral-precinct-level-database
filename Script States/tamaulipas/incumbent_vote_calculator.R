...
# Load the data
finaldb <- read_dta( "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/tamaulipas/tamaulipas_merged_IncumbentVote.dta")
...
#
write.csv(finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/tamaulipas/tamaulipas_FINAL_draft.csv")

#CLEAN DB
  # Select only the desired columns
  tamaulipas_finaldb <- finaldb %>% 
  select(
    state,
    mun,
    section,
  ...
  write.csv(tamaulipas_finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/tamaulipas/tamaulipas_FINAL.csv")
