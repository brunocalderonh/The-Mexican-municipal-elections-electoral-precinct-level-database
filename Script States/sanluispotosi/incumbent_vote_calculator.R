...
# Load the data
finaldb <- read_dta( "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/sanluispotosi/sanluispotosi_merged_IncumbentVote.dta")
...
write.csv(finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/sanluispotosi/sanluispotosi_FINAL_draft.csv")


#CLEAN DB
  # Select only the desired columns
  sanluispotosi_finaldb <- finaldb %>% 
  select(
    state,
    mun,
    section,
  ...
  write.csv(sanluispotosi_finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/sanluispotosi/sanluispotosi_FINAL.csv")
