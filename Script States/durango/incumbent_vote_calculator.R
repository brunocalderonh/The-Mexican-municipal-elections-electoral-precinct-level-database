...
# Load the data
finaldb <- read_dta( "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/durango/durango_merged_IncumbentVote.dta")
...
write.csv(finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/durango/durango_FINAL_draft.csv")


#CLEAN DB
  # Select only the desired columns
  durango_finaldb <- finaldb %>% 
  select(
    state,
    mun,
    section,
  ...
  write.csv(durango_finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/durango/durango_FINAL.csv")
