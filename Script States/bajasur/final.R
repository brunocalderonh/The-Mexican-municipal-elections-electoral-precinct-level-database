...
db <- read_excel("bajasur/bajasur_collapsed_edited.xlsx")
og <- read.csv("bajasur/bajasur_FINAL_draft.csv")
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/bajasur/bajasur_FINALV.csv")
