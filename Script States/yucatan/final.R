...
db <- read_excel("yucatan/yucatan_collapsed_edited.xlsx")
og <- read.csv("yucatan/yucatan_FINAL_draft.csv")
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/yucatan/yucatan_FINALV.csv")
