...
####MAGAR's incumbents ####
mag_db <- read.csv("incumbents magar/aymu.incumbents-que-zac.csv")
...
write_dta(mag_db, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/veracruz/Incumbents/incumbent_magar.dta")


#### INAFED incumbent ####
# Read the Excel file
inafed_db <- read_excel("incumbent INAFED/incumbents_veracruz_inafed.xlsx")
...
write_dta(inafed_db, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/veracruz/Incumbents/incumbent_inafed.dta")
...
jl_db <- jl_db %>%
  mutate(year = case_when(
    ...
    year == 2014 ~ 2013,
    year == 2018 ~ 2017,
    TRUE ~ year  # This keeps all other values unchanged
  ))


write_dta(jl_db, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/veracruz/Incumbents/incumbent_JL.dta")
...
write_dta(horacio_db, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/veracruz/Incumbents/incumbent_horacio.dta")
...
# Assuming merged_incumbent_data is a data frame
merged_incumbent_data <- merged_incumbent_data[!(merged_incumbent_data$uniqueid == 30041 & 
                                                   merged_incumbent_data$year == 2017 & 
                                                   merged_incumbent_data$incumbent_candidate_JL == "JOAQUIN FORTINO COCOTLE"), ]

write_dta(merged_incumbent_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/veracruz/Incumbents/incumbent_data_merged.dta")

#### MERGE INTO FINAL DB - INCUMBENT + VOTE ####
setwd("/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/veracruz/")

vote_db <- read_dta("veracruz_vote.dta")
...
write_dta(final_merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/veracruz/veracruz_merged_IncumbentVote.dta")
