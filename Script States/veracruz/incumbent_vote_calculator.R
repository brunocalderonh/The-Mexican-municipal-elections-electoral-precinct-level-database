...
# Load the data
finaldb <- read_dta( "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/veracruz/veracruz_merged_IncumbentVote.dta")
...
write.csv(finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/veracruz/veracruz_FINAL_draft.csv")


#CLEAN DB
  # Select only the desired columns
  veracruz_finaldb <- finaldb %>% 
  select(
    state,
    mun,
    section,
  ...
  write.csv(veracruz_finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/veracruz/veracruz_FINAL.csv")
