...
# Load the data
finaldb <- read_dta( "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/tabasco/tabasco_merged_IncumbentVote.dta")
...
write.csv(finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/tabasco/tabasco_FINAL_draft.csv")


#CLEAN DB
  # Select only the desired columns
  tabasco_finaldb <- finaldb %>% 
  select(
    state,
    mun,
    section,
  ...
  write.csv(tabasco_finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/tabasco/tabasco_FINAL.csv")
