...
db <- read_excel("tabasco/tabasco_collapsed_edited.xlsx")
og <- read.csv("tabasco/tabasco_FINAL_draft.csv")
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/tabasco/tabasco_FINALV.csv")
