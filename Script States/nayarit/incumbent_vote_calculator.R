...
# Load the data
finaldb <- read_dta( "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/nayarit/nayarit_merged_IncumbentVote.dta")
...
write.csv(finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/nayarit/nayarit_FINAL_draft.csv")

#CLEAN DB
  # Select only the desired columns
  nayarit_finaldb <- finaldb %>% 
  select(
    state,
    mun,
    section,
  ...
  write.csv(nayarit_finaldb, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/nayarit/nayarit_FINAL.csv")
