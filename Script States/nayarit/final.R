...
db <- read_excel("nayarit/nayarit_collapsed_edited.xlsx")
og <- read.csv("nayarit/nayarit_FINAL_draft.csv")
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/nayarit/nayarit_FINALV.csv")
