...
db <- read_excel("hidalgo/hidalgo_collapsed_edited.xlsx")
og <- read.csv("hidalgo/hidalgo_FINAL_draft.csv")
...
write.csv(merged_data, "/Users/brunocalderon/Library/CloudStorage/OneDrive-Personal/Documents/ITAM/RA - Horacio/Monitoring Brokers/Data/States/hidalgo/hidalgo_FINALV.csv")
